  ...
  import { faEnvelope, faPhone, faArrowRight, faCalendarDays } from "@fortawesome/free-solid-svg-icons";
  ...
  const FrontPageSection: React.FC = () => {
    ...
    const socialLinks = [
      ...
      { href: "calendly", icon: faCalendarDays, label: "Schedule Meeting", isCalendly: true },
    ];
        ...
        <div className="front-page-grid">
          ...
          <div className="hero-section">
            ...
            <div className="hero-actions">
              <div className="action-buttons">
                ...
                <a href="#CONTACTS" className="btn-secondary-fp">
              ...
              <div className="social-links">
                {socialLinks.map((social) => (
                  <a
                    ...
                    style={(social as any).isCalendly ? { cursor: 'pointer' } : undefined}
                  >
          ...
          <div className="right-section">
            ...
            <div className="projects-section">
              <div className="project-card_fp-container">
